...
namespace KeyHook
{
  ...
  public class KeyboardHook : IDisposable
  {
    ...
    public KeyboardHook()
    {
      ...
      m_HookProc = new WinApi.LowLevelKeyboardProc(lowLevelKeyboardHookCallback);
    ...
    public class KeyboardHookEventArgs : System.EventArgs
    {
      ...
      {
        m_KeyName = ((Keys)i_KeyCode).ToString();
        m_KeyCode = i_KeyCode;
      }
    }
